...
function iniciarJuego() {
    ...
    mokepones.forEach((mokepon) => {
       ...
       `
        ...
        inputHipongu = document.getElementById('Hipongu') 
        inputCapipepas = document.getElementById('Capipepas')
        inputEripyro = document.getElementById('Eripyro')
...
function seleccionarMascotaJugador() {
    sectionSeleccionarMascota.style.display = 'none'
        ...
        if(inputHipongu.checked) {
            spanMascotaJugador.innerHTML = inputHipongu.id
        } else if (inputCapipepas.checked) {
            spanMascotaJugador.innerHTML = inputCapipepas.id
        }else if(inputEripyro.checked) {
            spanMascotaJugador.innerHTML = inputEripyro.id
        }else {
